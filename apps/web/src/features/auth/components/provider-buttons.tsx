...
const buttonClass =
  ...
  "transition-all duration-200 hover:bg-white/[0.12] hover:border-white/20 " +
  "active:scale-[0.98]";

export function ProviderButtons() {
  return (
    <div className="flex w-full flex-col gap-3">
      <a href={signInUrl("google")} className={buttonClass}>
        <GoogleLogo />
        Continue with Google
      </a>
      <a href={signInUrl("microsoft")} className={buttonClass}>
        <MicrosoftLogo />
